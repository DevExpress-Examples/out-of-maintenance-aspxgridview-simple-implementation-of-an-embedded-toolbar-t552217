...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxGridView runat="server" ID="Grid" AutoGenerateColumns="False" ClientInstanceName="grid" KeyFieldName="ProductID" DataSourceID="DataSource"
                OnToolbarItemClick="Grid_ToolbarItemClick" Width="80%" OnRowDeleting="Grid_RowDeleting" OnRowUpdating="Grid_RowUpdating" OnRowInserting="Grid_RowInserting">
...
WHERE ProductID=@ProductID" InsertCommand="INSERT INTO Products (ProductName, QuantityPerUnit, UnitPrice, UnitsInStock, Discontinued) VALUES (@ProductName, @QuantityPerUnit, @UnitPrice, @UnitsInStock, @Discontinued)">
                <UpdateParameters>
